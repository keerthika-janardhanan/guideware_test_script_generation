...
- ✅ **Recorder Flow**: Session name → Record → Ingest → Choice
  - ✅ **Authentication Filtering**: Auto-removes Microsoft login steps
  - ✅ Stores original URL and filters auth redirects during refinement
  - ✅ Refined flows start from target application, not auth pages
